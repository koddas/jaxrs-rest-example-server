...
[Maven](http://maven.apache.org/), will produce a deployable WAR file.
...
*./target/jaxrs-rest-example-server-1.0.0.war*.
...
and select *./target/jaxrs-rest-example-server-1.0.0.war*. Once done, click the
*Launch* link and you're all set to try your new application. It will be made
available at *http://localhost:8080/jaxrs-rest-example-server-1.0.0*. You'll
be able to request a song at
*http://localhost:8080/jaxrs-rest-example-server-1.0.0/song/{name}*, where
*{name}* is the song that you wish to request.

# How do I configure my application?

## The web page

The web application (or *servlet* in Java lingo) comes with nothing but a very
basic GET endpoint. If you wish to have a look at Java-generated web pages,
please have a look at my slightly longer
[war-web-project tutorial](https://github.com/koddas/war-web-project].
...
*WebService.java*, that you'll find in
*src/main/java/se/idioti/example/jax-rs/rest/server*.
